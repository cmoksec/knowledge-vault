...
![image.png](Hello%20People%20-%20writeup/image.png)

upload.php - позволяет загружать файлы на сервер

![image.png](Hello%20People%20-%20writeup/image%201.png)
...
![image.png](Hello%20People%20-%20writeup/image%202.png)
...
![image.png](Hello%20People%20-%20writeup/image%203.png)
...
![image.png](Hello%20People%20-%20writeup/image%204.png)

Упакуем его в зип:

![image.png](Hello%20People%20-%20writeup/image%205.png)

Таким же образом загрузим его на сервер:

![Screenshot From 2025-01-20 16-23-53.png](Hello%20People%20-%20writeup/Screenshot_From_2025-01-20_16-23-53.png)
...
![image.png](Hello%20People%20-%20writeup/image%206.png)