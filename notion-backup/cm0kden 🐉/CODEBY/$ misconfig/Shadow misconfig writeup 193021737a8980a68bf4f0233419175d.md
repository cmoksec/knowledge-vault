...
![image.png](Shadow%20misconfig%20writeup/image.png)

Находим PoC:

![image.png](Shadow%20misconfig%20writeup/image%201.png)

Работает!

![image.png](Shadow%20misconfig%20writeup/image%202.png)

Декодируем бинарный текст, получаем пароль к одной из страниц.

![image.png](Shadow%20misconfig%20writeup/image%203.png)

Пробуем ввести пароль и получаем ссылку на новую страницу:

![image.png](Shadow%20misconfig%20writeup/image%204.png)

Это форма, где можно задать вопрос оракулу.

![image.png](Shadow%20misconfig%20writeup/image%205.png)

Легко обнаруживаем SQLi уязвимость.

![image.png](Shadow%20misconfig%20writeup/image%206.png)

Более того, это еще и UNION-based инъекция.

![image.png](Shadow%20misconfig%20writeup/image%207.png)
...
![image.png](Shadow%20misconfig%20writeup/image%208.png)

И пробуем достучаться к этому файлу по корню сайта.

![image.png](Shadow%20misconfig%20writeup/image%209.png)
...
![image.png](Shadow%20misconfig%20writeup/image%2010.png)

И проверяем, как работает, передаем параметром cmd команду:

![image.png](Shadow%20misconfig%20writeup/image%2011.png)

Бинго. Осталось найти флаг, с этим без проблем справляемся грепом.

![image.png](Shadow%20misconfig%20writeup/image%2012.png)

![image.png](Shadow%20misconfig%20writeup/image%2013.png)
