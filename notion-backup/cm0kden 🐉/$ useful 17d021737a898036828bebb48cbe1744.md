...
pseudohash — обфускация брутфорс листов, генерация паролей

domlogger++ — дебаг событий JS/DOM, здорово для поиска XSS

ars0n-framework — хороший фрейм для рекона

DOM Scanner — для динамического сканирования XSS

tldr — классный тул-альтернатива man, четко и по делу

Amazing tool for SSTI https://github.com/p0dalirius/objectwalker
