...
![image.png](file_upload_skill_assessment/image%204.png)
...
![image.png](file_upload_skill_assessment/image%205.png)
...
![forged filename: shell.phar.png](file_upload_skill_assessment/image%206.png)

forged filename: shell.phar.png

…

![minishell appended after the image](file_upload_skill_assessment/image%207.png)

minishell appended after the image

Let’s hit send:

![image.png](file_upload_skill_assessment/image%208.png)

Success, now we’ll access our webshell and get the flag:

![image.png](file_upload_skill_assessment/image%209.png)

![image.png](file_upload_skill_assessment/image%2010.png)
