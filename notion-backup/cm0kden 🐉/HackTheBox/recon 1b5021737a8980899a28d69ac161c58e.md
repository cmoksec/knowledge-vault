...
![where axfr - full zone transfer request type,@nsztm1.digi.ninja is a vulnerable DNS server, and [zonetransfer.me](http://zonetransfer.me) is a target domain which zone file should be extracted ](recon/image.png)
...
![Screenshot From 2025-03-13 21-48-30.png](recon/Screenshot_From_2025-03-13_21-48-30.png)
...
![image.png](recon/image%201.png)

Crawlers:

![image.png](recon/image%202.png)
...
[Information_Gathering_Web_Edition_Module_Cheat_Sheet.pdf](recon/Information_Gathering_Web_Edition_Module_Cheat_Sheet.pdf)