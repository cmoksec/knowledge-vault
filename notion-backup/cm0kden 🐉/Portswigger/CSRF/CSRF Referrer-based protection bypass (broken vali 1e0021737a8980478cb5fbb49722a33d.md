...
![image.png](CSRF%20Referrer-based%20protection%20bypass%20(broken%20vali/image.png)

Note: Referrer-Policy must be set to unsafe-url in order for this payload to work:

![image.png](CSRF%20Referrer-based%20protection%20bypass%20(broken%20vali/image%201.png)
