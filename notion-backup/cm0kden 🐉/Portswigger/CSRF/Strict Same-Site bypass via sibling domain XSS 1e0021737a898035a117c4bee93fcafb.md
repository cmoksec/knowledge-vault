...
![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image.png)

When READY sent to websocket server, it responds with a hull history

![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image%201.png)

Request to chat.js file discloses a sibling domain in Access-Control-Allow-Origin header:

![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image%202.png)

When checking a sibling domain, it’s easy to notice it’s vulnerable to XSS:

![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image%203.png)
...
![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image%204.png)

![image.png](Strict%20Same-Site%20bypass%20via%20sibling%20domain%20XSS/image%205.png)