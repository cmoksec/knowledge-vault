...
![image.png](sans%20alpha/image.png)

Углубляемся, находим файл флага

![image.png](sans%20alpha/image%201.png)
...
![image.png](sans%20alpha/image%202.png)

Произошло по сути вот что:

![image.png](sans%20alpha/image%203.png)
...
![image.png](sans%20alpha/image%204.png)
...
![image.png](sans%20alpha/image%205.png)

Осталось лишь передать этот файл в команду base64:

![image.png](sans%20alpha/image%206.png)

И декодировать строку:

![image.png](sans%20alpha/image%207.png)